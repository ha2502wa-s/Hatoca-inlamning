...
namespace CSharpWebService.WebServiceReference {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="CSharpWebServiceSoap", Namespace="http://hatoca.lu.se")]
    public partial class CSharpWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public CSharpWebService() {
            this.Url = global::CSharpWebService.Properties.Settings.Default.CSharpWebService_WebServiceReference_CSharpWebService;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://hatoca.lu.se/GetFileContent", RequestNamespace="http://hatoca.lu.se", ResponseNamespace="http://hatoca.lu.se", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        ...
        /// <remarks/>
        public void GetFileContentAsync(string filename) {
            this.GetFileContentAsync(filename, null);
        }
        
        /// <remarks/>
        public void GetFileContentAsync(string filename, object userState) {
            ...
            this.InvokeAsync("GetFileContent", new object[] {
                        filename}, this.GetFileContentOperationCompleted, userState);
        }
